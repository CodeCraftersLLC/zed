...
pub fn os_version() -> String {
    ...
    // The `not(feature = "test-support")` guards reproduce its first-match priority so
    // exactly one block survives cfg expansion and becomes the function's tail value.
